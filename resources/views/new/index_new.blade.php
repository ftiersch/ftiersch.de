...
<head>
    ...
    @vite('resources/css/new/app.css')
...
<div class="relative overflow-x-hidden w-full h-full">
    <header class="relative h-600 w-full bg-transparent bg-cover bg-fixed js-fullheight bg-[url('../../images/cover_bg_3.jpg')]" role="banner" data-stellar-background-ratio="0.5">
        ...
        <div class="flex h-screen">
            <div class="m-auto text-center transition-opacity ease-in duration-200 opacity-0 js-show-on-loaded">
                <div class="relative w-[200px] h-[200px] rounded-full my-0 mx-auto mb-[30px] bg-[url('../../images/profile.jpg')] bg-cover bg-center bg-no-repeat"></div>
    ...
    <div class="py-24 mt-20 bg-contrary">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="relative">
                ...
                @foreach($projectGroups as $group => $projects)
                    <div class="text-left lg:text-center pt-8">
                        <span class="relative bg-gray-300 rounded-[4px] tracking-[5px] uppercase text-[18px] font-[700] px-[15px] py-[7px] ml-[15px] lg:mx-auto z-10">{{ $group }}</span>
                        <div class="mt-10">
